    ...
    <div className="min-h-screen flex items-center justify-center bg-[#f7f7f9]">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-[#1a1a2e]">Create your Lodge account</h1>
          <p className="text-sm text-gray-500 mt-1">Get your agency workspace set up in minutes</p>
        </div>
        ...
        <p className="text-center text-sm text-gray-500 mt-6">
          ...
          <Link href="/login" className="text-[#5046e5] font-semibold hover:underline">
            Sign in
          </Link>
        </p>
